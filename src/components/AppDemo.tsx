  ...
  return (
    ...
    >
      ...
      <motion.path
        ...
        {...(isInView ? { stroke: '#6366f1', animate: { pathLength: 1 } } : {})}
        onUpdate={({ pathLength }) => {
        ...
        <div className="p-4">
          ...
          <div className="mt-3 border-t border-gray-200 pt-5">
              ...
              {percentageChange && (
                <div
                  className={clsx(
                    ...
                    percentageChange >= 0 ? 'text-indigo-500' : 'text-gray-500',
                  )}
                >
                  {`${
                    percentageChange >= 0 ? '+' : ''
            ...
            <div className="mt-6 flex gap-4 text-xs text-gray-500">
              <div>1D</div>
              <div>5D</div>
              <div className="font-semibold text-indigo-600">1M</div>
              <div>6M</div>
              <div>1Y</div>
              <div>5Y</div>
            </div>
            ...
            <div className="mt-4 rounded-lg bg-indigo-500 px-4 py-2 text-center text-sm font-semibold text-white">
              Trade
            </div>
