...
function DeviceUserIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#3b0764" fillOpacity={0.2} />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        <div className="px-4 py-6">
          <div className="space-y-6">
            {[
              ...
              { label: 'Email address', value: 'janedoe@example.com' },
            ].map((field) => (
              <div key={field.label}>
          ...
          <div className="mt-6 rounded-lg bg-indigo-500 px-3 py-2 text-center text-sm font-semibold text-white">
            Invite friend
          </div>
        </div>
      </MotionAppScreenBody>
      ...
      >
        <div className="px-4 py-6">
          <div className="space-y-4">
            ...
            <div className="rounded-lg bg-indigo-500 px-3 py-2 text-center text-sm font-semibold text-white">
              Buy shares
            </div>
          </div>
        </div>
